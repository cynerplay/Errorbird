...
if  __name__ == "__main__":
    ...
    pg.display.set_caption("FlappyDuck")
    ...
    game_image['pipe'] = (
        pg.transform.rotate(pg.image.load(pipe_img).convert_alpha(), 100),
        pg.image.load('images/pipe.png').convert_alpha(), 100
    )
